...
class EmployeeCRUD:
    ...
    def create_table(self):
        query = 'create table IF NOT EXISTS employees1(id int primary key auto_increment, name varcahr(50) not null, designation varchar(30), phone_number	bigint unique, salary float, commission		float default(0), years_of_experience tinyint, technology		varchar(30)	not null)'
        connection = self.connect_db()
        try:
            cursor = connection.cursor()
            cursor.execute(query)
